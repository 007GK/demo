<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="mb-10 bg-light-info p-8 rounded"><div class="text-info"> Use account <strong>demo@demo.com</strong> and password <strong>demo</strong> to continue. </div></div>
